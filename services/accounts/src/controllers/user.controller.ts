...
export class UserController {
  ...
  async fetchCurrentUser(
    ...
    // for symbol property
    console.log('IN UserController.fetchCurrentUser, currentUserProfile: >>>> ', currentUserProfile);
    // console.log('IN UserController.fetchCurrentUser, currentUserProfile: >>>> ', currentUserProfile[this.commonService.getSecurityId]);
